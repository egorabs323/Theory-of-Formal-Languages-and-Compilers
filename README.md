...
## 8) Описание интерфейса и функций (руководство пользователя): скриншоты работы программы и интерфейса с пояснением ключевых элементов с подробным указанием, как они вызываются (меню, кнопка, горячая клавиша) и что делают.
